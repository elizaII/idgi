...
public class LessonListAdapterNew extends NameableAdapter<LessonListAdapterNew.ViewHolder> {

    public LessonListAdapterNew(Context context, List<Lesson> lessons){
